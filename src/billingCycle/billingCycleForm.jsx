...
class BillingCycleForm extends Component {
    ...
    calculateSummary() {
        //t -> acumulador v -> valor atual
        const sum = (t, v) => t + v
        return {
            //+c Ou d.value -> converter uma string para valor numerico
...
{/* nao destruir os dados do form qnd o component for */}
...
//ele vai pegar o nome do atributo |credits|  do form ; ou seja vai me dar o array
